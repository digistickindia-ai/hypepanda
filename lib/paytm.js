...
export function paytmBase(mode) {
  // Production host updated per Paytm support (ticket TKT-145521):
  // old: https://securegw.paytm.in  →  new: https://secure.paytmpayments.com
  return mode === "production" ? "https://secure.paytmpayments.com" : "https://securegw-stage.paytm.in";
}
